...
//            _LiveMarketDataCache = new LiveMarketDataCache(_configuration.Object, _priceLogger.Object, _httpClientFactory.Object);
//        }
...
//            // Act
//            await LiveMarketDataCache.GetPriceFromTicker(ticker);
...
//            // Arrange
//            // Act and Assert
//            var result = await Assert.ThrowsAsync<ArgumentException>(async () => await _LiveMarketDataCache.GetPriceFromTicker(invalidTicker));
//        }
...
//            );
//            // Act and Assert
//            var result = await Assert.ThrowsAsync<HttpRequestException>(async () => await LiveMarketDataCache.GetPriceFromTicker(ticker));
//        }
//        [Fact]
...
//            );
//            // Act and Assert
//            var result = await Assert.ThrowsAsync<Exception>(async () => await LiveMarketDataCache.GetPriceFromTicker(ticker));
//        }
...
//            // Act and Assert
//            var result = await Assert.ThrowsAsync<JsonException>(async () => await LiveMarketDataCache.GetPriceFromTicker(ticker));
//        }
...
//            // Act and Assert
//            //Assert.True(await LiveMarketDataCache.GetPriceFromTicker(ticker) == null);
//        }
//    }
//}
